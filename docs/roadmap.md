...
## v1.1 (2026-06-22)
- [x] 30 new tickets added to `casus_data/demo-data/tickets.csv` (150 total, T-0121 to T-0150, May 2026)
- [x] `docs/dashboard.html` — interactive Chart.js dashboard (Pareto bars, trends table, routed tickets)
- [x] `reports/report.md` — Markdown report generated by n8n workflow alongside JSON reports
